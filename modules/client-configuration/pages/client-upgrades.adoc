...
For more information about service pack upgrades (product migration) that also covers migrating openSUSE Leap clients to {sle} clients, see xref:client-configuration:client-upgrades-product-migration.adoc[].
// endif::[]
